...
if ([string]::IsNullOrEmpty($workspaces))
{
    ...
    $deployment = New-AzureRmResourceGroupDeployment -Name $deploymentName `
                                       ...
                                       -TemplateUri "https://raw.githubusercontent.com/krnese/AzureDeploy/master/ManagedServices/Templates/omsWorkspace.json" `
    ...
    New-AzureRmDeployment -Name (get-random) `
                          -location $location `
                          -TemplateUri "https://raw.githubusercontent.com/krnese/AzureDeploy/master/ManagedServices/Templates/deployASCwithWorkspaceSettings.json" `
                          -securitySettings "On" `
